<?php
$sql_nhomtin = "SELECT * FROM nhom_tin ORDER BY id_nhomtin ASC ";
$sql_nhomtin1 = "SELECT * FROM nhom_tin ORDER BY id_nhomtin ASC ";
$sql_loaitin = "SELECT id_loaitin FROM loai_tin LIMIT 1";
					...
					<li class="has-children">
						...
						<ul class="sub-menu">
							<li class="has-children">
								...
								?>
									<a href="index.php?manage=categories&id=<?php echo $row_nhomtin['id_nhomtin'] ?>&id_loaitin=<?php echo $row_loaitin['id_loaitin'] ?>"><?php echo $row_nhomtin['ten_nhomtin'] ?></a>
								<?php
								}
								?>
							</li>
