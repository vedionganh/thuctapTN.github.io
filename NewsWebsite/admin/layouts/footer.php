...
<footer class="sticky-footer bg-white">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/NewsWebsite/admin/logout.php">Đăng xuất</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Page level plugins -->
    <!-- <script src="/NewsWebsite/public/admin/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="/NewsWebsite/public/admin/vendor/datatables/dataTables.bootstrap4.min.js"></script> -->

    <!-- Page level custom scripts -->
    <script src="/NewsWebsite/public/admin/js/demo/datatables-demo.js"></script>
